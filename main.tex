...
\makeatletter
% \newcommand{\newgraytheorem}[2]{
%     \newenvironment{#1}{\vskip 10\p@\begin{graybox}\begin{#2}}{
%       \end{#2}\end{graybox}\vskip 10\p@}
% }
\newcommand{\newgraytheorem}[2]{
    \newenvironment{#1}{\vskip 5\p@\begin{graybox}\begin{#2}}{
      \end{#2}\end{graybox}\vskip 5\p@}
}
\makeatother

% \newcommand{\boitegrise}[1]{
%   \colorbox{couleurchapeau}{\begin{minipage}{\textwidth}%
%   #1%
%   \end{minipage}}}
...
\newgraytheorem{theorem}{gtheorem}
\newtheorem{lemma}{Lemme}[chapter]
\newtheorem{proposition}{Proposition}[chapter]

\theoremstyle{definition}
\newtheorem{gdefinition}{Définition}[chapter]
\newgraytheorem{definition}{gdefinition}
...
\renewcommand{\chaptermark}[1]{\markboth{Chapitre\ \thechapter.\ #1}{}}
\renewcommand{\sectionmark}[1]{\markright{\thesection.\ #1 \hfill \thepage}{}}
%\renewcommand{\sectionmark}[1]{\markboth{\MakeUppercase{\thesection.\ %
%  Test section !}}{}}
% \renewcommand{\chaptermark}[1]{\markboth{\MakeUppercase{\chaptername\ \thechapter.\ %
%   \theheaderchapter}}{}}
% \newcommand{\theheaderchapter}{TEst !}
...
\begin{abstract}
  ...
  (made of up to hundreds of components, and potentially more).
