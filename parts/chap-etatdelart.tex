...
\chapeau{%
  ...
  et asynchrones des réseaux de régulation biologiques utilisées dans cette thèse.
  Nous y rappelons le principe et la définition du \emph{modèle de Thomas}
  et nous nous étendons brièvement sur les méthodes d'analyse qui existent sur ce modèle.
