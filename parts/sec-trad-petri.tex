...
Cette traduction de distingue donc de celle proposée par \citeasnoun[p.~47]{Pauleve11}
...
Pour terminer, nous montrons au \thmref{bisimulationphm2pt} que cette traduction
...
\todo{Preuve borné (en utilisant la dynamique)}
