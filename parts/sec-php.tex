...
Pour un modèle donné, si l'ensemble de toutes les actions reste le même,
...
par \citeasnoun{PMR12-MSCS} et dont le principe est rappelé à la \vsecref{ph-as-pf}.
...
\begin{example}
  \todo{Exemple de trois intervalles qui se recouvrent et impossibles à traduire fidèlement en PHp ?}
\end{example}
