...
\begin{remark}
  Il est intéressant de noter que la sur-approximation de \citeasnoun{PMR12-MSCS}
...
Le modèle de la \figref{livelock} traité \vpageref{livelock-as} en est un exemple.
