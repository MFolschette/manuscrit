...
%   \end{align}
\end{proposition}
La fonction $\f{signe}$ sur les entiers relatifs a été définie à la \vsecref{notations}.
...
est par exemple effectuée à l'aide du \textit{solver} \tool{Clingo} \cite{gekakasc14b}
