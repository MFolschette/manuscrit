...
développées au \chapref{phcanonique} afin d'en permettre une analyse toujours efficace.
% Leur second avantage est la possibilité d'appliquer les méthodes d'analyse statique
% qui sont étendues et adaptées à ces formalismes au chapitre \chapref{phcanonique}.
