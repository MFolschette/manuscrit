...
mais il utilisent des fonctions d'évolution (\defref{rda-def}) en lieu et place de paramètres
...
% 
% Comme il s'agit  de conditions nécessaires, la présence d'un cycle positif ou négatif
% ne produit pas nécessairement les comportements décrits,
% mais des travaux ont permis de décrire des situations où ces conditions deviennent suffisantes
% \cite{Comet13}.
% De façon générale, elles permettent donc d'obtenir un résultat qualitatif,
% %notamment en l'absence des cycles décrits,
% mais pas de résultat quantitatif sur le nombre de points fixes,
% le nombre ou la taille des oscillations, etc.
...
\citeasnoun{Naldi07} proposent de représenter sa paramétrisation
...
% Comme il s'agit de conditions nécessaires, la présence d'un circuit positif ou négatif
% ne produit pas nécessairement les comportements décrits,
% mais des travaux ont permis de décrire des situations où ces conditions deviennent suffisantes
% \cite{Comet13}.
% 
...
% l'ensemble des états stables mais aussi d'analyser la fonctionnalité des circuits.
% 
% Compression de modèles discrets : \cite{Naldi07}
%   qui utilisent des BDD : \cite{Bryant86,Srinivasan90}
% Optimisation de l'analyse mais dépend de paramètres liés à la modélisation
% 
% De plus, l'analyse de la paramétrisation permet
% 
% Comme il s'agit  de conditions nécessaires, la présence d'un circuit positif ou négatif
% ne produit pas nécessairement les comportements décrits,
% mais des travaux ont permis de décrire des situations où ces conditions deviennent suffisantes
...
% %Dans le cadre d'un modèle booléen (tel que $\forall x \in \Gamma, l_x = 1$)
...
% 
% Enfin, certaines analyses peuvent être effectuées non pas sur la dynamique
% 
% 
% 
% Compression de modèles discrets : \cite{Naldi07}
