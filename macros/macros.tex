...
\newcommand{\RDA}{\f{RDA}}
%\newcommand{\RDAdep}{\f{dep}}
\newcommand{\RDAtrans}[1][\RDA]{\trans{#1}}
\newcommand{\RRBtransrda}[2]{#1 \RDAtrans #2}
%\newcommand{\uns}{\pm}
\newcommand{\uns}{\circ}
...
\newcommand{\rdatophsymbol}{\f{toPH}}
\newcommand{\rdatoph}[1][\RDA]{\rdatophsymbol(#1)}
